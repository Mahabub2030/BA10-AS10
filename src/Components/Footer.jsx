...
const Footer = () => {
    return (
        ...
        <div>
            <div className="flex w-[40%] mx-auto rounded-xl p-5 flex-col justify-center text-center mb-14 mt-14 border ">
             ...
             <hr />
            <footer className="footer gird grid-cols-3 bg-white text-neutral-content p-10 shadow-2xl shadow-amber-100  ">
                <nav className="ml-24">
